...
import type { CaseServicosProps } from './types';

export default function CaseServicos({ items }: CaseServicosProps) {
          ...
          <div className={styles.servico__inner}>
            ...
            <div className={clsx(
              ...
              <div className={styles.servico__listCard} data-animate="fade-up" data-animate-delay="0.1">
                <p className={styles.servico__listTitle}>Entre as etapas da execução estão:</p>
